    ...
    def materialize(df: "DataFrame") -> "DataFrame":
        ...
        try:
            ...
            try:
                ...
                # and session is configured (spark.sparkless.useLogicalPlan=true)
        ...
        for op_name, op_val in df._operations_queue:
            try:
                if op_name == "filter":
                    ...
                    # op_val is ((columns_tuple), ascending_bool)
                    if op_val:
                        import functools
                        ...
                        if not isinstance(columns_to_sort, (list, tuple)):
                        ...
                        sorted_data = sorted(
                            current.data,
                            key=functools.cmp_to_key(_compare_rows),
                        )
                        current = DataFrame(
